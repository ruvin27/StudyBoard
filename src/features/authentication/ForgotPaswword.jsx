	...
	return (
		<div className={AuthCSS.containerforgotpass}>
			<div className={AuthCSS.wrapForgotpass}>
				...
				<form className={AuthCSS.forgotpasswordform} action="index.php" method="POST">
					<div className={AuthCSS.forgotpassInput}>
						<input className={AuthCSS.input100} type="email" name="email" placeholder="Enter Email" required />
					</div>
