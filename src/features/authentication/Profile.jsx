			...
			<div className={ProfileCSS.profile}>
				...
				<form action="#" method="post" enctype="multipart/form-data">
					<div className={ProfileCSS.formGroup}>
						...
						<input className={ProfileCSS.profileInput} type="text" id="name" value="Jane Smith" name="name" placeholder="Your Name" required />
					</div>
					<div className={ProfileCSS.formGroup}>
						<label for="email">Email:</label>
						<input className={ProfileCSS.profileInput} type="email" id="email" value="jane.smith@gmail.com" name="email" placeholder="Your Email" required disabled />
					</div>
					<div className={ProfileCSS.formGroup}>
						<label for="profile-picture">Profile Picture:</label>
						<input className={ProfileCSS.profileInput} type="file" id="profile-picture" name="profile-picture" />
					</div>
