	...
	return (
		<div className={AuthCSS.containerNewpass}>
			<div className={AuthCSS.wrapNewpass} >
				...
				<form className={AuthCSS.newpasswordform} action="index.php" method="POST">
					<div className={AuthCSS.newpasswordInput}>
						<input className={AuthCSS.input100} type="password" name="password" placeholder="Enter Password" required />
					</div>
					<div className={AuthCSS.newpasswordInput}>
						<input className={AuthCSS.input100} type="password" name="password" placeholder="Confirm Password" required />
					</div>
