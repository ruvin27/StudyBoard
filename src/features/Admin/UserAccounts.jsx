	...
	return (
		<div>
			...
			<div className={UserAccountsCSS.searchContainer}>
				<input type="text" className={UserAccountsCSS.searchInput} placeholder="Search..." />
			...
			<form id="userForm" className={UserAccountsCSS.form}>
				...
				<div className={UserAccountsCSS.autocompleteContainer}>
					...
					<div className={UserAccountsCSS.autocompleteSuggestions} id="autocompleteSuggestions"></div>
				</div>
