...
const NewPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      axios
        .put(`${LARAVEL_BACKEND_URL}/newpassword`, {
          email: email,
          code: code,
          password: password,
        })
  ...
  return (
    <div className={AuthCSS.containerNewpass}>
      <div className={AuthCSS.wrapNewpass}>
        ...
        <form className={AuthCSS.newpasswordform} onSubmit={handleSubmit}>
          <div className={AuthCSS.newpasswordInput}>
            <input className={AuthCSS.input100} type="password" name="password" placeholder="Enter Password" required value={password} onChange={handleChange} />
          </div>
          <div className={AuthCSS.newpasswordInput}>
            <input className={AuthCSS.input100} type="password" name="confirmPassword" placeholder="Confirm Password" required value={confirmPassword} onChange={handleChange} />
          </div>
