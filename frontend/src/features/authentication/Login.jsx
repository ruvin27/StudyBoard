...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await axios
      .post(`${LARAVEL_BACKEND_URL}/login`, {
    ...
    <div className={LoginCSS.containerLogin}>
      <div className={LoginCSS.wrapLogin}>
        ...
        <form className={LoginCSS.loginform} onSubmit={handleSubmit}>
          ...
          <div className={LoginCSS.loginInput}>
            <input className={LoginCSS.input100} type="password" name="password" placeholder="Enter Password" autoComplete="current-password" value={formData.password} onChange={handleChange} />
          </div>
