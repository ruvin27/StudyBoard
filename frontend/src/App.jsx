...
import ExamResultsGraph from '@features/commonComponents/ExamResultsGraph';
    ...
    <div>
      <Router>
        ...
        <Routes>
          ...
          <Route path="/examresultgraph/:examId/:exam" element={user ? <ExamResultsGraph /> : <NotAuthorized />} />
        </Routes>
        {user && <Chat />}
      </Router>
    </div>
